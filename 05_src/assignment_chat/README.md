...
and provide information about countries via a RESTful API
...
4. A reranker selects the best match using:
   - filename hints (e.g., "story", "plot", "character")
...
- open-source
- simplicity
- rich integration with major AI tools and framework including OpenAI
...
│   └── Russia_WTO_talks.txt
├── embeddings/
│   └── chroma/        (auto‑generated by ChromaDB)
└── README.md
```
